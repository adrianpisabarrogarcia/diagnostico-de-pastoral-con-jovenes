    ...
    <div class="row justify-content-center align-items-center minh-100">
        <div class="p-3 p-md-5 m-5 col-10 col-md-5 rounded" id="scuare">
            ...
            <div class="mb-5">
                ...
                <p class="text-center">
                    <b>¿Quieres saber si tienes las 🛠 perfectas en tu pastoral?</b> Contesta a este formulario y te aydaremos a identificar qué aréas necesitas mejorar 👨‍🔧 o de lo contrario celebrarlo 🎉.
                </p>
            </div>
